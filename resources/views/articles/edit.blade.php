    ...
    <form method="POST" action="{{route('articles.update',$article)}}">
        ...
        <div class="form-group p-2">
            ...
            <input id="title" type="text" name="title" class="form-control" placeholder="Title" maxlength="255"
                   value="{{old('title',$article->title)}}" spellcheck="false"/>
            @if($errors->has('title'))
        ...
        <div class="form-group p-2">
            ...
            >{{old('short_description',$article->short_description)}}</textarea>
        ...
        <div class="form-group p-2">
            ...
            <input id="picture" type="text" name="picture" class="form-control"
                   ...
                   value="{{old('picture',$article->picture)}}" spellcheck="false"/>
